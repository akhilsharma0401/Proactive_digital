...
const timeline = [
  {
    year: "2008",
    text: "Proactive Digital Solution Services began with a vision delivering full-stack web and cloud solutions that laid the foundation for future innovation.",
  },
  {
    year: "2010",
    ...
    text: "We stepped into web development and Enterprise Communication Solution, helping businesses build stronger digital identities and measurable growth online.",
    // text: "We began our journey in website development, creating scalable and performance-driven online experiences.",
  },
  {
    year: "2012",
  ...
  },
  {
    ...
    text: "We evolved our website development practice by integrating modern frameworks, cloud-ready architecture, and performance engineering to deliver scalable growth-focused solutions.",
  },
  {
    year: "2024",
...
function page() {
  ...
  return (
    <div>
        ...
        <div className="relative w-full py-0 md:py-12 overflow-hidden">
          ...
          <div className="relative flex flex-col gap-10 justify-center items-center h-full w-full z-10 py-10 px-5 lg:px-10  ">
            ...
            <div className="flex flex-col gap-4 text-center max-w-7xl ">
              {/* title */}
              <p className="poppins text-[#3e66f3] font-semibold text-[16px] md:text-[20px] lg:text-[22px] ">
                OUTSMART YOUR COMPETITORS{" "}
              </p>
              <h1 className="poppins text-[30px] md:text-[38px] lg:text-[42px] font-semibold text-black leading-sung">
              ...
              <div className="hidden md:block">
                <p className="open-sans text-[14px] md:text-[18px] text-gray-800 text-center">
          ...
          <div id={`section-${index}`} key={index} className="flex items-center bg-white ">
            <div className="grid grid-cols-1 md:grid-cols-3 h-full w-full mt-30  gap-0 md:gap-8 2xl:gap-20 text-[18px] bg-white">
              ...
              <div className="col-span-1 flex justify-between text-center text-black  gap-6 h-18 md:h-auto">
                ...
                <div className="text-[18px] lg:text-[22px] poppins text-[#3e66f3] mt-10 lg:mt-18 me-5">
                  {item.title}
                </div>
              </div>
      ...
      {/* <section className="text-white p-4 lg:p-0 space-y-4 ">
        {visionData.map((item, index) => (
          <div id={`section-${index}`} key={index} className="flex items-center justify-center my-0 lg:my-0">
            <div className="grid grid-cols-1 md:grid-cols-3 h-full w-full container mx-auto sm:px-10 md:px-10 2xl:px-15 md:py-16 lg:p-6 mt-30 md:mt-30  gap-0 md:gap-8 text-[18px] bg-white">
              
              <div className="col-span-1 flex justify-around text-center text-black  gap-6 h-10 md:h-auto">
                <div className="text-[60px] md:text-[100px] font-bold text-transparent stroke-black stroke-[1px]">
                  {item.number}
                </div>
              ...
              <div className="col-span-2 flex flex-col  gap-6 max-w-2xl">
      ...
      {/* Timeline */}
      <section className="relative max-w-7xl mx-auto py-10 lg:py-12 px-6 lg:px-10 2xl:px-15 overflow-hidden">
            ...
            >
              <div className="md:w-1/2 relative group">
                ...
                <motion.div
                  ...
                  className="relative bg-white/70 backdrop-blur-2xl border border-white/40 shadow-lg hover:shadow-[0_10px_35px_rgba(0,0,0,0.1)] transition-all duration-600 rounded-2xl p-8"
                >
      ...
      <section className="max-w-7xl mx-auto py-10  px-6 lg:px-10 2xl:px-16 ">
          ...
          <div className="flex flex-col justify-center gap-4">
            <div className="flex">
              <p className="open-sans text-[16px] text-gray-700  text-center md:text-start  ">
                We're not just a digital agency, we're your growth partners.With a mix of creativity, data, and smart technology, we help brands stand out, scale faster, and stay ahead in an ever-changing digital world.
              </p>
            </div>
      ...
      {/* Map Section */}
      <section className="max-w-7xl mx-auto  py-10 px-6 lg:px-10 2xl:px-15 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Jaipur */}
          <div className="group bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-md transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
            ...
            <div className="relative overflow-hidden">
              <Image
                ...
                width={400}
                height={200}
                className="object-cover w-full h-40 lg:h-48 transition-transform duration-700 group-hover:scale-110"
              />

              <div className="absolute top-4 left-4 bg-white/20 backdrop-blur-md px-4 py-1 rounded-full text-base font-medium text-blue-700">
                Rajasthan
              </div>
            </div>

            <div className="flex flex-col gap-2 lg:gap-3 p-3 lg:p-4 text-center">
              <h2 className="text-xl lg:text-2xl font-semibold text-[#3e66f3]">
                Jaipur
              </h2>

              <p className="text-gray-700 text-sm lg:text-base ">
                22, 3rd Floor, Biswa Nagar,<br />
          ...
          <div className="group bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-md transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
            ...
            <div className="flex flex-col gap-2 lg:gap-3 p-3 lg:p-4 text-center">
              ...
              <p className="text-gray-700 text-sm lg:text-base ">
                F-9 Usha Chambers, Deep Central Market,<br />
                Ashok Vihar, Phase-1,<br />
      ...
      {/* cta */}
      <section className="bg-[url('/images/diagonalStripes.svg')] bg-repeat bg-auto py-10 " >
        <div className="max-w-7xl mx-auto px-6 lg:px-10 2xl:px-15 ">
          <div className="relative flex flex-col md:flex-row bg-linear-to-r from-blue-50 to-blue-50 shadow-lg h-auto md:h-75  rounded-3xl md:rounded-4xl overflow-hidden justify-between">
            {/* background svg */}
            <svg
      ...
      <section className=" bg-white max-w-7xl mx-auto flex justify-center items-center py-10 px-6 lg:px-10 2xl:px-15 ">
        <div className="w-full   bg-[#f9fafc] border border-[#D1CDE3] rounded-xl p-4 md:p-6 shadow-lg space-y-6">
